...
public class MainFragment extends Fragment implements OnMapReadyCallback, ReportDialog.DialogCallBack, GoogleMap.OnMarkerClickListener  {
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        //  Fetch image from cloud storage when event loads in the map
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        marker.icon(BitmapDescriptorFactory
                .fromResource(R.drawable.boy));  // defaultMarker(BitmapDescriptorFactory.HUE_ROSE));
...
//                                // Ask dialog to take the label and words
